#############################################################################################################################################
RISK-DASU-12-3(T68) Повторювана закупівля у одного постачальника близька до порогу визначенного Законом ('reporting', роботи, 10% нижче 1.5М)
#############################################################################################################################################
...
---------------------------------------
 Для процедур типу *допорогові закупівлі* розрахунок індикатора вимикається тоді,  коли з моменту завершення процедури (``data.date``) проходить 2 доби.
