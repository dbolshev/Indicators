########################################################################################
РИЗИК2-1П. Застосування переговорної процедури закупівлі (попередньо двічі відмінено торги через відсутність достатньої кількості учасників) із збільшенням очікуваної вартості [та кількості ] закупівлі більше ніж на [30%/40%/50%] ДПА: (В переговорній процедурі закупівлі (причина двічі відмінені торги) замовник значним чином (більше [10%]) змінив кількість товару який закупає, при чому очікувана вартість не змінюється, або змінена не суттєво (менше 10%)).
########################################################################################
