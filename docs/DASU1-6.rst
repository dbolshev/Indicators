#####################################################################
ДАСУ1-6 Повторювана закупівля коли замовником вже було здійснено допорогову закупівлю (тендер або звіт) з однаковим кодом предмета закупівлі (cpv), загальна сума яких дорівнює або перевищує 1,500 тис. грн.
#####################################################################
