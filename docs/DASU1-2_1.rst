#################################################################################################################
ДАСУ1-2_1 Закупівля товарів та послуг понад "європейські пороги" проведена з порушенням порядків розгляду, розкриття та електронного аукціону (Закупівля товарів та послуг кваліфікується як відкриті торги (EU), але замовником обрана інша процедура)
#################################################################################################################
