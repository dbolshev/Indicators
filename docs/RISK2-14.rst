==================================================================================================================================================
РИЗИК2-14. Недопуск до оцінки більше ніж 2-х учасників при проведенні процедури закупівлі робіт (понад "європейські пороги")
==================================================================================================================================================
...
--------------------------------------
Подія, що вмикає розрахунок індикатора - процедура переходить у статус ``data.status = 'active.active.pre-qualification.stand-still'``.
...
Індикатор розраховується один раз для кожного лота.
...
2. Якщо для лота є 3 або більше об'єкта зі статусом ``data.qualifications.status = 'unsuccessful'``, індикатор приймає значення ``1``. Інакше - індикатор приймає значення ``0``.
