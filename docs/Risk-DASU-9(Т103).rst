...
Даний індикатор виявляє ситуації, коли дискваліфікував усіх учасників лота або процедури (якщо вона однолотова), окрім переможця.
...
4. Якщо для лота "Переможець" = 1 та "Учасники" = "Переможець" + "Дискваліфікації", то індикатор приймає значення "``1``".
