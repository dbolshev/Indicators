...
1. Для замовника який здійснює переговорну процедуру з метою дозакупки процедур:ref:`tv_procuringEntity` та предмета закупівлі або частин предмету закупівлі :ref:`tv_tenderCPVList` у аналітичній таблиці :ref:`tbl_PESupplierCPV4` шукається хоча б одна процедура, де співпаде ідентификатор замовника, ідентификатор постачальника, а :ref:`tv_tenderCPVList` переговорної процедури повністю входить в:ref:`tv_tenderCPVList` знайденої.
