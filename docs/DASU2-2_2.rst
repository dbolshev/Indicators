...
Подія, що вмикає розрахунок індикатора - завершення періоду подачі заявок на участь в аукціоні, тобто значення змінної ``data.status`` стає рівним ``active.awarded``.
