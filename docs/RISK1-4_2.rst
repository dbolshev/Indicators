#####################################################################################
RISK1-4_2 Перевищення строку розгляду тендерної пропозиції (більше 20 днів), яка за результатами оцінки визначена найбільш економічно вигідною
#####################################################################################
...
3.2. Від поточної дати до дати ``data.awards.date`` більше 20 *робочих* днів.
