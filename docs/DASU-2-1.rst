################################################################################################################
DASU-2-1 Закупівля товарів та послуг понад "європейські пороги" проведена з порушенням порядків розгляду, розкриття та електронного аукціону
################################################################################################################
...
Подія, що вмикає розрахунок індикатора - публікація замовником у електронній системі закупівель оголошення про проведення закупівлі

Подія, що вимикає розрахунок індикатора
---------------------------------------

Розрахунок індикатора вимикається при закінченні періоду подачі пропозицій
