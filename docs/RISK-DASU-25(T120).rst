...
4. Для змін контракту з пункту 3 знаходимо найранішу дату ``data.changes.dateSigned``. Якщо вона відрізняється від ``data.dateSigned`` менше ніж на 30 днів, то індикатор приймає значення ``1``. 
