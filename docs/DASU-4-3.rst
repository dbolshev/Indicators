...
- ``aboveThresholdEU`` - *відкриті торги*
...
----------------
########
ДЕНИС ОПИШИ ТУТ ТАКИМ ОБРАЗОМ ЧТОБ ИНДИКАТОР НАЧИНАЛ СЧИТАТЬСЯ ОТ ДАТЫ КОГДА ЛОТ В ПРОЦЕДУРЕ СТАЛ   - ``active.pre-qualification`` И ЕСЛИ ОН В ТАКОМ СТАТУСЕ БОЛЬШЕ 20 ДНЕЙ ЧТОБ СРАБАТЫВАЛ ИНДИКАТОР. 
########
