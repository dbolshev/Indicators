=======================================================================================
ДАСУ2-3П. Переможець торгів виграв усі лоти тендеру (тендер на 5+ лотів, що відбулися).
=======================================================================================
...
1. У процедурі має бути від 5-ти лотів, тобто кількість активних об'єктів з різними ``data.lots.id`` >= 5, що мають ``data.status = 'active'``.
...
3. Якщо виконуються перші дві умови, індикатор приймає значення ``1``.
