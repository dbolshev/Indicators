...
2. Серед документів, що були взяті до уваги, обраховується найпізніша дата публікації, тобто *максимальна* з дат ``data.documents.datePublished`` (З ДАСУ ПОТРІБНО УЗГОДИТИ ЦЕ ПРИПУЩЕННЯ)
