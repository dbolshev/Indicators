##########################################################################################################
RISK-DASU-12-2(T68) Закупівля близька до порогу визначенного Законом ('reporting', роботи, 10% нижче 1.5М)
##########################################################################################################
...
---------------------------------------
 Для процедур типу *допорогові закупівлі* розрахунок індикатора вимикається тоді, коли закінчується період подачі пропозицій. 
